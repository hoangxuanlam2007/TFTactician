        ...
        <section className="container post">
            <div className="row">
                <div className="col-12">
                    <div className="page-header"><h1>Privacy Policy</h1>
                    </div>
                    ...
                    <div className="article">
                        ...
                        <li>
                        <p>Company (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TFTactician.</p>
                        </li>
                        <li>
                        ...
                        <li>
                        <p>Website refers to TFTactician, accessible from <a href="/">here</a></p>
                        </li>
                        <li>
                        ...
                        <hr />
                        <h3>Personal Data</h3>
                        <p>While using Our Service, We are not ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Every thing we collected are your free will includes:</p>
                        <ul>
                        <li>
                        <p>Email address</p>
                        </li>
                        ...
                        <p>Your usage data will be saved on firebase cloud storage.</p>
                        <p>We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.</p>
                        <h3>Tracking Technologies and Cookies</h3>
                        <p>We don't use any Cookies or similar tracking technologies to track the activity on Our Service and store certain information.</p>
                        ...
                        <ul>
                        <li>By email: chim31102007@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
